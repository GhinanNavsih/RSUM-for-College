    ...
    try {
      ...
      if (patient) {
        setFormData({
          ...
          jenisKelamin: patient.jenisKelamin || 'Laki-laki',
          ...
          kontakPenanggungJawab: patient.kontakPenanggungJawab || '',
        });

        // Check if it's "Pasien Sendiri"
        if (patient.hubunganPenanggungJawab === 'Pasien Sendiri') {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Perbarui data pasien di bawah ini</p>
        </div>
